...
uint8_t  i;
// 各关节初始角度(度)，以舵机中位为 0°
const float jointHome[4] = {30.00f, 30.00f, 30.00f, 30.00f};
...
const uint8_t jointDir[4] = {1, 0, 1, 1};
// 预设点位数量
...
const float presetPos[PRESET_COUNT][4] = {
    {100.00f, 80.00f, 50.00f, 45.00f},  // P1 关节角度: [38.7, -29.2, 105.0, -30.8]
    {60.00f, 60.00f, 20.00f, 0.00f}  // P2 关节角度: [45.0, -33.1, 144.3, -111.2]
};
...
void main()
{
    ...
    targetX = 109.64f; targetY = 63.30f; targetZ = 149.28f; targetPhi = 90.00f;
    ik_reachable = 1;
    while (1)
    {
        // 测试手柄连接状态
