#ifndef __STC32G144K246_H__
#define __STC32G144K246_H__
...
#define     TH11                    (*(unsigned char volatile far *)0x7efe7a)
#define     TL11                    (*(unsigned char volatile far *)0x7efe7b)
...
#define     TH6                     (*(unsigned char volatile far *)0x7efbb4)
#define     TL6                     (*(unsigned char volatile far *)0x7efbb5)
#define     TH5                     (*(unsigned char volatile far *)0x7efbb6)
#define     TL5                     (*(unsigned char volatile far *)0x7efbb7)
...
#define     T6                      (*(unsigned int  volatile far *)0x7efbb4)
#define     T5                      (*(unsigned int  volatile far *)0x7efbb6)
...
#define     TH8                     (*(unsigned char volatile far *)0x7efbbc)
#define     TL8                     (*(unsigned char volatile far *)0x7efbbd)
#define     TH7                     (*(unsigned char volatile far *)0x7efbbe)
#define     TL7                     (*(unsigned char volatile far *)0x7efbbf)
...
#define     T8                      (*(unsigned int  volatile far *)0x7efbbc)
#define     T7                      (*(unsigned int  volatile far *)0x7efbbe)
...
#define     TH10                    (*(unsigned char volatile far *)0x7efbc4)
#define     TL10                    (*(unsigned char volatile far *)0x7efbc5)
#define     TH9                     (*(unsigned char volatile far *)0x7efbc6)
#define     TL9                     (*(unsigned char volatile far *)0x7efbc7)
...
#define     T9                      (*(unsigned int  volatile far *)0x7efbc4)
#define     T10                     (*(unsigned int  volatile far *)0x7efbc6)
...
#define     TH18                    (*(unsigned char volatile far *)0x7efbcc)
#define     TL18                    (*(unsigned char volatile far *)0x7efbcd)
#define     TH17                    (*(unsigned char volatile far *)0x7efbce)
#define     TL17                    (*(unsigned char volatile far *)0x7efbcf)
...
#define     T18                     (*(unsigned int  volatile far *)0x7efbcc)
#define     T17                     (*(unsigned int  volatile far *)0x7efbce)
...
#define     SPI2INTR                (*(unsigned char volatile far *)0x7ef80f)
...
#define     SPI3INTR                (*(unsigned char volatile far *)0x7ef82f)
...
#define     PGA1_CR                 (*(unsigned int  volatile far *)0x7ef600)
#define     PGA2_CR                 (*(unsigned int  volatile far *)0x7ef604)
#define     PGA3_CR                 (*(unsigned int  volatile far *)0x7ef608)
#define     PGA4_CR                 (*(unsigned int  volatile far *)0x7ef60c)
...
#define     DAC1_DAT                (*(unsigned int  volatile far *)0x7ef612)
#define     DAC1_DIV                (*(unsigned int  volatile far *)0x7ef614)
...
#define     DAC2_DAT                (*(unsigned int  volatile far *)0x7ef62a)
#define     DAC2_DIV                (*(unsigned int  volatile far *)0x7ef62c)
...
#define     IAP_XDATA               ( (unsigned char volatile far *)0x7ef5f0)
#define     IAP_XDATA0              (*(unsigned char volatile far *)0x7ef5f0)
#define     IAP_XDATA1              (*(unsigned char volatile far *)0x7ef5f1)
#define     IAP_XDATA2              (*(unsigned char volatile far *)0x7ef5f2)
#define     IAP_XDATA3              (*(unsigned char volatile far *)0x7ef5f3)
#define     IAP_XDATA4              (*(unsigned char volatile far *)0x7ef5f4)
#define     IAP_XDATA5              (*(unsigned char volatile far *)0x7ef5f5)
#define     IAP_XDATA6              (*(unsigned char volatile far *)0x7ef5f6)
#define     IAP_XDATA7              (*(unsigned char volatile far *)0x7ef5f7)
#define     IAP_XDATA8              (*(unsigned char volatile far *)0x7ef5f8)
#define     IAP_XDATA9              (*(unsigned char volatile far *)0x7ef5f9)
#define     IAP_XDATAA              (*(unsigned char volatile far *)0x7ef5fa)
#define     IAP_XDATAB              (*(unsigned char volatile far *)0x7ef5fb)
#define     IAP_XDATAC              (*(unsigned char volatile far *)0x7ef5fc)
#define     IAP_XDATAD              (*(unsigned char volatile far *)0x7ef5fd)
#define     IAP_XDATAE              (*(unsigned char volatile far *)0x7ef5fe)
#define     IAP_XDATAF              (*(unsigned char volatile far *)0x7ef5ff)
...
#define     CAN_RTIE                (*(unsigned char volatile far *)0x7ef4a4)
...
#define     CAN_ACF_EN              ( (unsigned char volatile far *)0x7ef4b6)
...
#define     CAN2_RTIE               (*(unsigned char volatile far *)0x7ef3a4)
...
#define     CAN2_ACF_EN             ( (unsigned char volatile far *)0x7ef3b6)
...
#define     EP1INIF                 0x02
#define     EP0IF                   0x01
#define     INTRIN2                 (USBBASE + 3)
#define     EP15INIF                0x80
#define     EP14INIF                0x40
#define     EP13INIF                0x20
#define     EP12INIF                0x10
#define     EP11INIF                0x08
#define     EP10INIF                0x04
#define     EP9INIF                 0x02
#define     EP8INIF                 0x01
#define     INTROUT1                (USBBASE + 4)
#define     EP7OUTIF                0x80
#define     EP6OUTIF                0x40
#define     EP5OUTIF                0x20
#define     EP4OUTIF                0x10
#define     EP3OUTIF                0x08
#define     EP2OUTIF                0x04
#define     EP1OUTIF                0x02
#define     INTROUT2                (USBBASE + 5)
#define     EP15OUTIF               0x80
#define     EP14OUTIF               0x40
#define     EP13OUTIF               0x20
#define     EP12OUTIF               0x10
#define     EP11OUTIF               0x08
#define     EP10OUTIF               0x04
#define     EP9OUTIF                0x02
#define     EP8OUTIF                0x01
...
#define     EP1INIE                 0x02
#define     EP0IE                   0x01
#define     INTRIN2E                (USBBASE + 8)
#define     EP15INIE                0x80
#define     EP14INIE                0x40
#define     EP13INIE                0x20
#define     EP12INIE                0x10
#define     EP11INIE                0x08
#define     EP10INIE                0x04
#define     EP9INIE                 0x02
#define     EP8INIE                 0x01
#define     INTROUT1E               (USBBASE + 9)
#define     EP7OUTIE                0x80
#define     EP6OUTIE                0x40
#define     EP5OUTIE                0x20
#define     EP4OUTIE                0x10
#define     EP3OUTIE                0x08
#define     EP2OUTIE                0x04
#define     EP1OUTIE                0x02
#define     INTROUT2E               (USBBASE + 10)
#define     EP15OUTIE               0x80
#define     EP14OUTIE               0x40
#define     EP13OUTIE               0x20
#define     EP12OUTIE               0x10
#define     EP11OUTIE               0x08
#define     EP10OUTIE               0x04
#define     EP9OUTIE                0x02
#define     EP8OUTIE                0x01
...
#define     FIFO6                   (USBBASE + 38)
#define     FIFO7                   (USBBASE + 39)
#define     FIFO8                   (USBBASE + 40)
#define     FIFO9                   (USBBASE + 41)
#define     FIFO10                  (USBBASE + 42)
#define     FIFO11                  (USBBASE + 43)
#define     FIFO12                  (USBBASE + 44)
#define     FIFO13                  (USBBASE + 45)
#define     FIFO14                  (USBBASE + 46)
#define     FIFO15                  (USBBASE + 47)
...
#define     DMA_ADC1_VECTOR         48      //0183H
#define     DMA_SPI_VECTOR          49      //018BH
#define     DMA_SPI1_VECTOR         49      //018BH
...
#define     DMA_I2C1T_VECTOR        60      //01E3H
#define     DMA_I2CR_VECTOR         61      //01EBH
#define     DMA_I2C1R_VECTOR        61      //01EBH
#define     I2S_VECTOR              62      //01F3H
#define     I2S1_VECTOR             62      //01F3H
#define     DMA_I2ST_VECTOR         63      //01FBH
#define     DMA_I2S1T_VECTOR        63      //01FBH
#define     DMA_I2SR_VECTOR         64      //0203H
#define     DMA_I2S1R_VECTOR        64      //0203H
...
#define     DMA_DAC1_VECTOR         77      //026BH
...
#define     DMA_CAN1T_VECTOR        117     //03ABH
#define     DMA_CANR_VECTOR         118     //03B3H
#define     DMA_CAN1R_VECTOR        118     //03B3H
