...
func _initialize() -> void:
	...
	_check("四声部使用 Us_Delay 最短 1us 时间片轮换", code.contains("MUSIC_MAX_VOICES 4")
		and code.contains("MUSIC_VOICE_SWITCH_US 1UL")
		and code.contains("remaining_us = segment->duration_ms * 1000UL")
		and code.contains("Us_Delay(switch_us)")
		and code.contains("remaining_us -= switch_us"))
