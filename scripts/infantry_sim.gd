...
## 摩擦轮占空比 -> 弹丸初速（m/s）。800 对应校内赛安全硬上限
const MUZZLE_DUTY_LO: float = 500.0
const MUZZLE_DUTY_HI: float = 800.0
...
# ------------------------------------------------------------------ 音效
## 摩擦轮音调直接等于占空比数值（500 duty -> 500Hz，800 duty -> 800Hz）
...
## 摩擦轮颜色随占空比连续渐变：
## 未启动（< 500）冷灰，500 橙色，800 橙红，中间线性插值。
