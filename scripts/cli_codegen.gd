...
func _infantry_schema() -> Dictionary:
	return {
		...
		"l1_io": {"type": "string", "description": "左前轮 IO（扩展板通信脚+方向脚，如 'P74 P24'；P64/P66 不可选）", "default": "P74 P24"},
		"l2_io": {"type": "string", "description": "左后轮 IO（P64/P66 不可选）", "default": "P75 P25"},
		"r1_io": {"type": "string", "description": "右前轮 IO（P64/P66 不可选）", "default": "P76 P26"},
		"r2_io": {"type": "string", "description": "右后轮 IO（P64/P66 不可选）", "default": "P77 P27"},
		...
		"booster_io": {"type": "string", "description": "拨弹电机 IO（单引脚，扩展板；P64/P66 不可选）", "default": "P60"},
	...
	return {
		"music": {
			...
			"properties": {
				...
				"polyphonic": {"type": "boolean", "default": false},
				"track_index": {"type": "integer", "minimum": 0},
				"track_indices": {"type": "array", "minItems": 1,
				...
				"segments": {
					...
					"items": {
						"type": "object",
						"required": ["notes", "duration_ms"],
						"properties": {
							"notes": {"type": "array", "maxItems": 4,
								"items": {"type": "integer", "minimum": 1, "maximum": 127},
								"description": "按音高降序排列的 MIDI 音符；空数组表示休止"},
