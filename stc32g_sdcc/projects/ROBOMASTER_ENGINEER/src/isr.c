...
void UART3_Isr(void) __interrupt (17)
{
...
void UART4_Isr(void) __interrupt (18)
{
...
//{
// }
// void TM1_Isr(void) __interrupt (3)
//{
// }
// void TM2_Isr(void) __interrupt (12)
//{
// }

// void TM4_Isr(void) __interrupt (20)
//{
// }
// void DMA_ADC_ISR_Handler (void) __interrupt (ADCDMA_VECTOR)
//{
// }
// void INT0_Isr(void) __interrupt (0);
// void TM0_Isr(void) __interrupt (1);
// void INT1_Isr(void) __interrupt (2);id  TM1_Isr()   __interrupt (3);
// void UART1_Isr(void) __interrupt (4);
...
// void UART3_Isr(void) __interrupt (17);
// void UART4_Isr(void) __interrupt (18);
// void TM3_Isr(void) __interrupt (19);
// void TM4_Isr(void) __interrupt (20);
// void CMP_Isr(void) __interrupt (21);
// void I2C_Isr(void) __interrupt (24);
// void USB_Isr(void) __interrupt (25);
// void PWM1_Isr(void) __interrupt (26);
// void PWM2_Isr(void) __interrupt (27);
