 ...
 * @brief  OLED���ַ���
 * @exampleCode
 *      LCD_P6x8Str(0,0,"w.pie") //����ʼ����xΪ0��yΪ0����һ��w.pie���ַ���
 * @endcode
 * @param[in]  x    x��ʼ����
 * @param[in]  y    y��ʼ����(����)             
 * @param[in]  ch[] �ַ���
 ...
 * @brief  OLED���ַ���
 * @exampleCode
 *      LCD_P8x16Str(0,0,"w.pie") //����ʼ����xΪ0��yΪ0����һ��w.pie���ַ���
 * @endcode
 * @param[in]  x    x��ʼ����
 * @param[in]  y    y��ʼ����(����)             
 * @param[in]  ch[] �ַ���
 ...
 * @exampleCode
        unsigned int a;
 *      LCD_PrintU16(0,0,a) //����ʼ����xΪ0��yΪ0�ĵط���ʾ����a��ֵ
 * @endcode
 * @param[in]  x    x��ʼ����
 * @param[in]  y    y��ʼ����(����)             
 * @param[in]  num  Ҫ��ʾ�ı���
 ...
 * @exampleCode
        float a;
 *      LCD_PrintFloat(0 , 0 , a , 7) //����ʼ����xΪ0��yΪ0�ĵط���ʾ����a��ֵ,һ����ʾ7λ
 * @endcode
 * @param[in]  x    x��ʼ����
 * @param[in]  y    y��ʼ����(����)             
 * @param[in]  num  Ҫ��ʾ�ı���
