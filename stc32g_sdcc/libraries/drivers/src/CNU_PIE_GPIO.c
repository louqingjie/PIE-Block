 ...
 * @brief  ��ʼ��GPIO����
 * @exampleCode
				GPIO_Init(GPIO_P0, GPIO_Pin_0, GPIO_PullUp); //��ʼ��P00���Ų�����Ϊ׼˫��IO
 * @endcode
 * @param[in]  GPIO_Port GPIO�˿ں�
 * @param[in]  GPIO_Pin  GPIO���ź�              
 * @param[in]  GPIO_Mode GPIO��������
***************************************************************************************************************************/
void GPIO_Init(GPIO_Port_enum GPIO_Port , GPIO_Pin_enum GPIO_Pin , GPIO_Mode_enum GPIO_Mode)
 {
	 switch (GPIO_Port)
	 {
		 case GPIO_P0://�˿�0
			 ...
			 {
				 case GPIO_PullUp:
					 P0M1 &= ~GPIO_Pin,	P0M0 &= ~GPIO_Pin;	 break;//����׼˫���			 
				 case GPIO_HighZ:
					 P0M1 |=  GPIO_Pin,	P0M0 &= ~GPIO_Pin;   break;//��������
				 case GPIO_OUT_OD:
					 P0M1 |=  GPIO_Pin,	P0M0 |=  GPIO_Pin;	 break;//��©���
     ...
     case GPIO_P1://�˿�1
			 ...
			 {
				 case GPIO_PullUp:
					 P1M1 &= ~GPIO_Pin,	P1M0 &= ~GPIO_Pin;	 break;//����׼˫���			 
				 case GPIO_HighZ:
					 P1M1 |=  GPIO_Pin,	P1M0 &= ~GPIO_Pin;   break;//��������
				 case GPIO_OUT_OD:
					 P1M1 |=  GPIO_Pin,	P1M0 |=  GPIO_Pin;	 break;//��©���
     ...
     case GPIO_P2://�˿�2
			 ...
			 {
				 case GPIO_PullUp:
					 P2M1 &= ~GPIO_Pin,	P2M0 &= ~GPIO_Pin;	 break;//����׼˫���			 
				 case GPIO_HighZ:
					 P2M1 |=  GPIO_Pin,	P2M0 &= ~GPIO_Pin;   break;//��������
				 case GPIO_OUT_OD:
					 P2M1 |=  GPIO_Pin,	P2M0 |=  GPIO_Pin;	 break;//��©���
     ...
     case GPIO_P3://�˿�3
			 ...
			 {
				 case GPIO_PullUp:
					 P3M1 &= ~GPIO_Pin,	P3M0 &= ~GPIO_Pin;	 break;//����׼˫���			 
				 case GPIO_HighZ:
					 P3M1 |=  GPIO_Pin,	P3M0 &= ~GPIO_Pin;   break;//��������
				 case GPIO_OUT_OD:
					 P3M1 |=  GPIO_Pin,	P3M0 |=  GPIO_Pin;	 break;//��©���
     ...
     case GPIO_P4://�˿�4
			 ...
			 {
				 case GPIO_PullUp:
					 P4M1 &= ~GPIO_Pin,	P4M0 &= ~GPIO_Pin;	 break;//����׼˫���			 
				 case GPIO_HighZ:
					 P4M1 |=  GPIO_Pin,	P4M0 &= ~GPIO_Pin;   break;//��������
				 case GPIO_OUT_OD:
					 P4M1 |=  GPIO_Pin,	P4M0 |=  GPIO_Pin;	 break;//��©���
     ...
     case GPIO_P5://�˿�5
			 ...
			 {
				 case GPIO_PullUp:
					 P5M1 &= ~GPIO_Pin,	P5M0 &= ~GPIO_Pin;	 break;//����׼˫���			 
				 case GPIO_HighZ:
					 P5M1 |=  GPIO_Pin,	P5M0 &= ~GPIO_Pin;   break;//��������
				 case GPIO_OUT_OD:
					 P5M1 |=  GPIO_Pin,	P5M0 |=  GPIO_Pin;	 break;//��©���
     ...
     case GPIO_P6://�˿�6
			 ...
			 {
				 case GPIO_PullUp:
					 P6M1 &= ~GPIO_Pin,	P6M0 &= ~GPIO_Pin;	 break;//����׼˫���			 
				 case GPIO_HighZ:
					 P6M1 |=  GPIO_Pin,	P6M0 &= ~GPIO_Pin;   break;//��������
				 case GPIO_OUT_OD:
					 P6M1 |=  GPIO_Pin,	P6M0 |=  GPIO_Pin;	 break;//��©���
     ...
     case GPIO_P7://�˿�7
			 ...
			 {
				 case GPIO_PullUp:
					 P7M1 &= ~GPIO_Pin,	P7M0 &= ~GPIO_Pin;	 break;//����׼˫���			 
				 case GPIO_HighZ:
					 P7M1 |=  GPIO_Pin,	P7M0 &= ~GPIO_Pin;   break;//��������
				 case GPIO_OUT_OD:
					 P7M1 |=  GPIO_Pin,	P7M0 |=  GPIO_Pin;	 break;//��©���
 ...
 * @brief  ����GPIO������������ -4.1k
 * @exampleCode
 *      uint8_t status ; //���ڴ洢��ʼ��״̬
 *      status = GPIO_PinPullConfig(GPIO_P0, GPIO_Pin_0, GPIO_Pull_Up); //����P00��������4.1k����
 * @endcode
 * @param[in]  GPIO_Port GPIO�˿ں�
 * @param[in]  GPIO_Pin  GPIO���ź�              
 * @param[in]  GPIO_Pin_Config GPIO�����Ƿ���������
 * @retval 0 ʧ��
 * @retval 1 �ɹ�
***************************************************************************************************************************/
uint8_t GPIO_PinPullConfig(GPIO_Port_enum GPIO_Port , GPIO_Pin_enum GPIO_Pin , GPIO_PinConfig GPIO_Pin_Config)
 {
	 ...
	 if(GPIO_Pin_Config > GPIO_NO_PULL)  return FAIL; //��ʼ������ֵ����FAIL
 ...
 * @brief  ����GPIO���ŵ�ƽ
 * @exampleCode
 *     	GPIO_Write_Bit(GPIO_P0, GPIO_Pin_0, 0);   //����P00����Ϊ�͵�ƽ
 * @endcode
 * @param[in]  GPIO_Port GPIO�˿ں�
 * @param[in]  GPIO_Pin  GPIO���ź�              
 * @param[in]  data_t    GPIO���ŵ�ƽ
***************************************************************************************************************************/
 ...
 * @brief  ��ȡGPIO���ŵ�ƽ
 * @exampleCode
 *      uint8_t status ; //���ڴ洢���ŵ�ƽ
 *      status = GPIO_Read_Bit(GPIO_P0, GPIO_Pin_0); //��ȡP00���ŵ�ƽ
 * @endcode
 * @param[in]  GPIO_Port GPIO�˿ں�
 * @param[in]  GPIO_Pin  GPIO���ź�              
 * @retval 0 �͵�ƽ
 ...
 * @brief  ��תGPIO���ŵ�ƽ
 * @exampleCode
 *      GPIO_Toggle_Bit(GPIO_P0, GPIO_Pin_0);   //��תP00���ŵ�ƽ
 * @endcode
 * @param[in]  GPIO_Port GPIO�˿ں�
 * @param[in]  GPIO_Pin  GPIO���ź�              
***************************************************************************************************************************/
void GPIO_Toggle_Bit(GPIO_Port_enum GPIO_Port , GPIO_Pin_enum GPIO_Pin)
 {
	 ...
	 switch (GPIO_Port)
	 {
		 case GPIO_P0:  P0 ^= GPIO_Pin ; break;	//�˿�0			
     case GPIO_P1:  P1 ^= GPIO_Pin ; break;	//�˿�1			
     case GPIO_P2:  P2 ^= GPIO_Pin ; break;	//�˿�2			 
     case GPIO_P3:  P3 ^= GPIO_Pin ; break;	//�˿�3			 
     case GPIO_P4:  P4 ^= GPIO_Pin ; break;	//�˿�4			
     case GPIO_P5:  P5 ^= GPIO_Pin ; break;	//�˿�5			 
     case GPIO_P6:  P6 ^= GPIO_Pin ; break;	//�˿�6		
     case GPIO_P7:  P7 ^= GPIO_Pin ; break;	//�˿�7
		 default:
		 break;				 
	 }
 }
