 ...
 * @brief  TIMER��ʼ������
 * @exampleCode
 *      Timer_Count_Init(TIMER3_P04); //��ʼ����ʱ��3 P04������Ϊ��������
 * @endcode
 * @param[in]  Timer_Count_Pin  ��ʱ����������
***************************************************************************************************************************/
 ...
 * @brief  TIMER��ȡ����������������
 * @exampleCode
 *      Timer_Count_Read(TIMER3_P04); //��ʱ��3 P04���Ŷ�ȡ������ֵ
 * @endcode
 * @retval   count  ��������
***************************************************************************************************************************/
 ...
 * @brief  TIMER��������
 * @exampleCode
 *      Timer_Count_Clear(TIMER3_P04); //��ʼ����ʱ��3 P04���ż�������
 * @endcode
***************************************************************************************************************************/
 ...
 * @brief  TIMER��ʱ�жϳ�ʼ��
 * @exampleCode
 *      PIT_Timer_Ms(TIM0 �� 20); //��ʼ����ʱ��0��Ϊ�ж�Դ��20ms��ʱ�ж�
 * @endcode
 * @param[in]  Timer_CHN  ��ʱ��ͨ����
 * @param[in]  Time       �ж�ʱ��
***************************************************************************************************************************/
void PIT_Timer_Ms(TIMER_CHN_Enum Timer_CHN , uint16_t Time)
{
 ...
 /**************************************************************************************************************************
 * @brief  TIMER��ʱ�ж�����жϱ�־λ
 * @exampleCode
 *      PIT_Timer_Clear(TIM0); //TIM0�жϱ�־λ���
 * @endcode
 * @param[in]  Timer_CHN  ��ʱ��ͨ����
***************************************************************************************************************************/
