...
typedef struct
{
	uint8_t	WDT_Enable;				//���Ź�ʹ��  	ENABLE,DISABLE
	uint8_t	WDT_IDLE_Mode;		//IDLEģʽֹͣ����		WDT_IDLE_STOP,WDT_IDLE_RUN
	uint8_t	WDT_PS;						//���Ź���ʱ��ʱ�ӷ�Ƶϵ��		WDT_SCALE_2,WDT_SCALE_4,WDT_SCALE_8,WDT_SCALE_16,WDT_SCALE_32,WDT_SCALE_64,WDT_SCALE_128,WDT_SCALE_256
} WDog_InitTypeDef;
