[CmdletBinding()]
param(
[ValidateSet('0000.培训模板', '0001.JDY08设置密码', 'FRICTION_CALIBRATION', 'LCD_SPI_SMOKE', 'PWM_SMOKE', 'PWM_B_SMOKE', 'TIMER_IRQ_SMOKE', 'UART1_IRQ_SMOKE', 'ROBOMASTER_ENGINEER', 'ROBOMASTER_INFANTRY', 'TEST')]
    [string]$Project = 'TEST',
    [switch]$All,
    [switch]$SmokeTest,
